...
// const Index = () => {
  ...
  handleScroll() {
    ...
    <div>
      ...
      <TopImage />
      <TopSeconds />
      <div className="demo1 scrollIn"></div>
      <div className="demo2 scrollIn"></div>
      <div className="demo3 scrollIn"></div>
      <div className="flex">
      <div className="demo4 scrollIn"></div>
      <div className="demo5 scrollIn"></div>
      <div className="demo6 scrollIn"></div>
      </div>
      <PageTopButton />
      <style jsx>{`
        .demo1 {
