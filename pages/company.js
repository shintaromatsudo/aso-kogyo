  ...
  <div className="company">
    ...
    <table style={{ borderCollapse: 'collapse' }}>
      ...
      <tr>
        ...
        <td className="border-left">資本金を400万円に増資</td>
      </tr>
      <tr>
        <td>
        ...
        <td className="border-left">資本金を800万円に増資</td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        ...
        <td className="border-left">資本金を1600万円に増資</td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        ...
        <td className="border-left">新社長に石井哲哉が就任。</td>
      </tr>
      <tr>
        <td>
    ...
    <img src="../static/img/soshikizu.jpg" />
    <style jsx>{`
      p {
        text-align: center;
      }
